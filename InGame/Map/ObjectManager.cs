    ...
    public class ObjectManager
    {
        ...
        public void DrawMiddle(SpriteBatch spriteBatch)
        {
            ...
            if (GameSettings.EnableShadows && Owner.UseShadows && !Game1.GameManager.UseShockEffect && ShadowTexture != null)
            {
                ...
                spriteBatch.Draw(ShadowTexture, new Rectangle(0, 0, Game1.GameManager.CurrentRenderWidth, Game1.GameManager.CurrentRenderHeight), Color.Black * GameSettings.ShadowOpacity);
                spriteBatch.End();
            }
        }
